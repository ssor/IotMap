	...
	*/
	public function logout()
	{
		//if ($_SESSION['changeRole']!=1) {
			...
			session_destroy();			
		$host = $_SERVER['HTTP_HOST'];
		$strEcho = "<script language='javascript' type='text/javascript'>";
		$strEcho.= "top.location.href = 'http://".$host."/index.php/Welcome/welcome'";
		$strEcho.= "</script>";	
		echo $strEcho;	
	...
	public function checkLogin()
	{
		...
		echo "<script language='javascript' type='text/javascript'>";
		echo "top.location.href = 'http://".$host."/index.php/Monitor/index'";
		echo "</script>";
		return;
